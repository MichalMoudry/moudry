...
import EduListItem from '@/components/molecules/EduListItem.vue';
...
import WorkExpListItem from '@/components/molecules/WorkExpListItem.vue';
...
<template>
  <Card>
    ...
    <p>
        IT Student and .NET developer. Nowadays, working mostly in C# and .NET
        ecosystem developing web services and other types of applications. Currently,
        I am learning Go, C++, Vue.js and Powershell.
    </p>
  </Card>

  <Card class="mt-4">
    <IconHeader icon="briefcase" text="Work Experience" />
    <WorkExpListItem position=".NET Developer" employer="Ciklum Western Europe" start-date="Jul 2022" />
    <hr class="my-4" />
    <WorkExpListItem position="Technology Support Administrator" employer="IBM, Czech Republic" start-date="Jun 2020" end-date="Aug 2021" description="Working with an ECM system and its separate system for document digitalization (Datacap). Part of this work included development of a COM library for integrating Datacap with an ECM system through a SOAP API." />
    <hr class="my-4" />
    <WorkExpListItem position="Service Technician/Web developer" employer="Zettabyte IT, London" start-date="Feb 2017" end-date="Feb 2017" description="Working in a computer repair shop, where my primary responsibility was to repair computers. Additionally, I contributed to their internal web application, that was written in PHP language." />
  </Card>
  ...
  <Card class="mt-4">
    ...
    <RouterLink to="/skills" class="mt-4 w-full" title="View skills page">
        <IconButton icon="chevron-right" content="More skills" class="w-full" />
    </RouterLink>
  </Card>
  ...
  <Card class="mt-4">
    ...
    <p>Native or bilingual speaker knowledge</p>
    <hr class="my-4" />
