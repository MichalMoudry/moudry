...
<Card>
    ...
    <p>
        .NET developer and occasionally a security engineer.
        Nowadays, working mostly in C# and .NET ecosystem developing web services and other types of applications.
        Currently, I am learning Go, C++ and Powershell.
    </p>
</Card>
...
<Card classes="mt-4">
	...
	<WorkExpListItem
		...
		startDate="Feb 2017"
		endDate="Feb 2017"
		description="Worked in a computer repair shop, where my primary responsibility was to repair computers. Additionally, I contributed to their internal web application, that was written in PHP language."
	/>
</Card>
